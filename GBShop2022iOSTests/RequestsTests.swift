...
class RequestsTests: XCTestCase {
    ...
    // TODO: объединить в одну тестовую модель
//    (например, создать TestsModel, там создавать тестовую структуру, а сюда только передавать эту структуру), это существенно сократит и количество переменных,
//    и объем кода. А также добавит читаемость
